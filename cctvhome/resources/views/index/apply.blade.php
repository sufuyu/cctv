...
<head>
	...
	<link href="{{asset('common/css/check_in.css-v=20170713184940.css')}}" tppabs="{{asset('common/css/ppsshow/2.0/style/check_in.css?v=20170713184940')}}" type="text/css" rel="stylesheet"/>
</head>
<body>
<!-- 导航 -->
<div class="site-nav">
					...
					<div class="eyes-tip site-nav-app-download" style="display: none;" data-clickbodyhide="1">
						<ul class="app-download-list">
							...
							<li class="download-item dl-xiu">
								<a href="" tppabs="http://mbdapp.iqiyi.com/j/ot/iQiyiCamera_Setup.exe" data-pb-rseat="20" class="dl">cctv直播伴侣</a>
							</li>
						</ul>
...
<div class="site-header " data-pb-block="15041001">
		<div class="inner">
			<h1 class="logo" title="cctv"><a href="index.htm" tppabs="http://x.pps.tv/" data-pb-rseat="1">cctv主播秀场</a></h1>
						<ul class="nav">
				<li>
...
<div id="wrapper">
	<div class="content">
		<div class="apply-category">
			<a href="anchor.htm" tppabs="http://x.pps.tv/enter/anchor" class="apply-anchor">
				<span class="icon-mic"></span>
				<span class="text">主播申请</span>
			</a>
			<a href="fzone.htm" tppabs="http://x.pps.tv/enter/fzone" class="apply-family">
				<span class="icon-house"></span>
				<span class="text">家族申请</span>
			</a>
		</div>
	</div>
</div>
<script type="text/javascript"> var xiu_pv_stat_ut =
	1500024763.9945 </script>
	<div id="footer">
		<div class="footmenu">
			<ul>
