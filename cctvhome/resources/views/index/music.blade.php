...
<head>
	...
	<title>cctv好音乐 精彩唱不停-cctv</title>
	<meta name="keywords" content="美女直播,视频聊天,视频交友cctv,秀场,爱奇艺秀场,PPS秀场,美女主播,美女视频,视频直播,美女秀场,真人秀场,在线K歌,视频交友,真人视频">
	<meta name="description" content="cctv是爱奇艺旗下大型在线互动娱乐社区，国内最高清的真人视频直播平台。海量美女主播、明星歌手与你“零距离”互动，支持百万人同时在线。视频聊天、K歌比拼、歌舞表演，有趣有爱有美女。赶快加入，与美女主播免费聊天。">
	<link href="{{asset('common/css/blank.css-v=20170713184940.css')}}" tppabs="{{asset('common/css/blank.css?v=20170713184940')}}" type="text/css" rel="stylesheet">
		<link href="{{asset('common/css/qixiu_musician_p2.css-v=20170713184940.css')}}" tppabs="{{asset('common/css/qixiu_musician_p2.css?v=20170713184940')}}" type="text/css" rel="stylesheet">
	
	<script>
		var _PAGE_CONF = _PAGE_CONF || {};
		</script>
</head>
<body>
<!--浏览器自适应-->
...
_pre_setPageWidth(_pre_configList);
	...
	<div class="site-header " data-pb-block="15041001">
		<div class="inner">
			<h1 class="logo" title="cctv"><a href="index.htm" tppabs="http://x.pps.tv/" data-pb-rseat="1">cctv美女主播秀场</a></h1>
						<ul class="nav">
				<li>
...
<div class="pagebody">
    ...
    <div class="activity-banner">
        <a href="176791.htm" tppabs="http://x.pps.tv/room/176791" class="banner-link" target="room">进入直播间</a>
    </div>
    <!-- wrap -->
    <div class="page-wrap">
        <!-- panel-->
        <div class="activity-panel">
            <h2><i class="icon-h icon-earphone"></i>给爱听歌的你</h2>
            <p class="info">每晚7:00-10:00，会唱歌的主播都在这里！多种风格雅俗共赏，让你邂逅更多好声音！</p>
            <ul>
                <li class="l-i-1">
                    <h4>周一至周五 | cctv好音乐</h4>
                    <p>互动点歌听你想听！</p>
        ...
        <!-- panel-->
        <div class="activity-panel">
            <h2><i class="icon-h icon-earphone"></i>好音乐人气榜</h2>
            <p class="info">根据主播单次轮播收礼金额排行，月底清零。<br>当月多次参加轮播，榜单保留最高成绩，最多刷榜8次。<br>
        月底榜单前六名进行“月度最佳歌手”角逐，冠军可获得丰厚官方奖励。</p>
            <ul>
                <li class="l-i-1">
                    <h4>第1名 | 牛北北(102892)</h4>
                    <p>成绩34.2万</p>
                </li>
                <li class="l-i-2">
                    <h4>第2名 | 蜜蜂(154980)</h4>
            ...
            <p class="info">第4名 婉婉(105356) 成绩12.2万 ；第5名 余甜甜(102853) 成绩8.0万 ；第6名 王大可(125226) 成绩6.3万 ；<br>第7名 糖宝(174755) 成绩5.1万 ；第8名 佐儿(176073) 成绩5.0万 ；第9名 神仙(167611) 成绩3.6万 ；<br>第10名 小珍珠(129849) 成绩3.2万 ；第11名 怪兽(148487) 成绩2.5万 ；第12名 56花(145073) 成绩2.4万  </p>
        </div>
        <!-- panel-->
        <div class="activity-panel">
            <h2><i class="icon-h icon-earphone"></i>给爱唱歌的你</h2>
            <p class="info">渴望一展歌喉？期待更多关注？求得家人守护？<br>那就来cctv好音乐吧，每晚热门资源位传递你的音乐态度，后续将会有更多官方推荐机会！</p>
            <div class="alert-block">
                <p>报名资格：邀请所有通过认证的音乐人（已获得<i class="icon-yinfu"></i>勋章）报名加入“cctv好音乐”</p>
                <p>报名方式：发送主播信息至官方<i class="icon-qq"></i><span>QQ:459716882</span></p>
            </div>
            <p class="info">
                如果你还未申请过认证音乐人，立即申请吧！（请勿重复申请）
                <a href="musician.htm" tppabs="http://x.pps.tv/topic/musician" target="_blank" class="act-default">立即申请</a>
            </p>
        </div>
    </div>
    <div class="activity-copyright">
        ©本活动最终解释权归cctv所有
    </div>
</div></div>
<script type="text/javascript"> var xiu_pv_stat_ut =
	1500024792.6277 </script>
	<div id="footer">
		<div class="footmenu">
			<ul>
...
<script type="text/javascript" src="{{asset('common/js/jquery-1.7.2.min.js-v=1.0.0')}}" tppabs="{{asset('common/js/jquery-1.7.2.min.js?v=1.0.0')}}"></script>
	...
	<script data-js-version="20170713184940" data-flash-version="20170713181027" type="text/javascript" charset="utf-8" src="{{asset('common/js/require-min.js-v=1.0.0')}}" tppabs="{{asset('common/js/require-min.js?v=1.0.0')}}"></script>
	<script>
		var _hmt = _hmt || [];
				require(['http://static.iqiyi.com/js/ppsshow/common/header.js?v=20170713184940'], function () {
