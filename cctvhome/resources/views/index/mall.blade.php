...
_pre_setPageWidth(_pre_configList);
	...
	<div class="site-header mall-page" data-pb-block="15041001">
		<div class="inner">
	...
	<div id="wrapper">
		...
		<div class="tab-content">
			...
			<div class="goods-wrap" data-tb-block="506262_0" data-pb-block="506262">
				<h2 class="section-title open-gz-title">开通贵族</h2>
				<ul class="gz-goods">
					<li class="gz-js _badgeItem">
						<div class="goods-pic">
							<img alt="爵士" src="wp_gz_jueshi_100x100.png" tppabs="http://www.qiyipic.com/ppsxiu/fix/sc/wp_gz_jueshi_100x100.png" height="100" width="100">
							<p class="name">爵士</p>
						</div>
						<div class="gz-detail">
							<p class="permission">
								<span class="label">防踢</span>
								<em class="em-p">管理员</em>以下不可踢
							</p>
							<p class="permission">
								<span class="label">入场动画</span>
								弹簧鞋
							</p>
							<p class="permission">
								<span class="label">喊话特权</span>
								<em class="em-bg-general">蓝色</em>
							</p>
							<p class="permission last-perm">
								<span class="label">喊话</span>
								5秒/次
							</p>
							<div class="buy-wrap">
							</div>
						</div>
					</li><li class="gz-nj _badgeItem">
						<div class="goods-pic">
							<img alt="男爵" src="wp_gz_nanjue_100x100.png" tppabs="http://www.qiyipic.com/ppsxiu/fix/sc/wp_gz_nanjue_100x100.png" height="100" width="100">
							<p class="name">男爵</p>
						</div>
						<div class="gz-detail">
							<p class="permission">
							...
							<!--html/mall/_gz_buy_wrap.html begin-->
							<div class="buy-wrap">
							</div>
							<!-- /.buy-wrap -->
							<!--html/mall/_gz_buy_wrap.html end-->
						</div>
					</li><li class="gz-zj _badgeItem">
						<div class="goods-pic">
							<img alt="子爵" src="wp_zijue_100x100.png" tppabs="http://www.qiyipic.com/ppsxiu/fix/sc/wp_zijue_100x100.png" height="100" width="100">
							<p class="name">子爵</p>
						</div>
						<div class="gz-detail">
							<p class="permission">
								<span class="label">防禁文本</span>
								<em class="em-p">管理员</em>以下不可禁
							</p>
							<p class="permission">
								<span class="label">防踢</span>
								<em class="em-p">管理员</em>以下不可踢
					...
					</li><li class="gz-bj _badgeItem">
						<div class="goods-pic">
							<img alt="伯爵" src="wp_gz_bojue_100x100.png" tppabs="http://www.qiyipic.com/ppsxiu/fix/sc/wp_gz_bojue_100x100.png" height="100" width="100">
							<p class="name">伯爵</p>
						</div>
						<div class="gz-detail">
							<p class="permission">
								<span class="label">防喊话被禁</span>
								<em class="em-p">白银守护</em>以下不可禁
							</p>
							<p class="permission">
								<span class="label">防禁文本</span>
								<em class="em-p">管理员</em>以下不可禁
					...
					</li><li class="gz-hj _badgeItem">
						<div class="goods-pic">
							<img alt="侯爵" src="wp_gz_houjue_100x100.png" tppabs="http://www.qiyipic.com/ppsxiu/fix/sc/wp_gz_houjue_100x100.png" height="100" width="100">
							<p class="name">侯爵</p>
						</div>
						<div class="gz-detail">
							<p class="permission">
								<span class="label">防喊话被禁</span>
								<em class="em-p">黄金守护</em>以下不可禁
							</p>
							<p class="permission">
								<span class="label">防禁文本</span>
								<em class="em-p">管理员</em>以下不可禁
					...
					</li><li class="gz-gj _badgeItem">
						<div class="goods-pic">
							<img alt="公爵" src="wp_gz_gongjue_100x100.png" tppabs="http://www.qiyipic.com/ppsxiu/fix/sc/wp_gz_gongjue_100x100.png" height="100" width="100">
							<p class="name">公爵</p>
						</div>
						<div class="gz-detail">
							<p class="permission">
								<span class="label">防喊话被禁</span>
								<em class="em-p">房主</em>以下不可禁
							</p>
							<p class="permission">
								<span class="label">防禁文本</span>
								<em class="em-p">房主</em>以下不可禁
					...
					</li><li class="gz-gw _badgeItem">
						<div class="goods-pic">
							<img alt="国王" src="wp_gz_guowang_100x100.png" tppabs="http://www.qiyipic.com/ppsxiu/fix/sc/wp_gz_guowang_100x100.png" height="100" width="100">
							<p class="name">国王</p>
						</div>
						<div class="gz-detail">
							<p class="permission">
				...
				<p class="tip">
											亲，你尚未开通贵族哦～
						<em class="em-o">开通贵族，尊享更多特权！</em>
									</p>
			</div>
			<div class="gz-how">
				<h2 class="section-title show-title">如何开通</h2>
...
<script type="text/javascript" src="{{asset('common/js/jquery-1.7.2.min.js-v=1.0.0')}}" tppabs="{{asset('common/js/jquery-1.7.2.min.js?v=1.0.0')}}"></script>
	...
	<script>
		var _hmt = _hmt || [];
				require(['http://static.iqiyi.com/js/ppsshow/web_v2/buyNobility.js?v=20170713184940'], function () {
