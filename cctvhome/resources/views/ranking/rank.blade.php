...
<div class="site-nav">
	...
	<div class="clearfix">
		...
		<div class="ranks-wrap host-ranks">
			<h2 class="page-title">
				人气魅力等级榜<span class="ico ico-logo-m"></span>
				<a class="ico ico-help-small">
					<p class="tip">根据主播获得的星光个数排名<span class="arrow"><span class="inner"></span></span></p>
				</a>
			</h2>
<!-- 			<ul class="tab-title" data-pb-block="15041019">
	<li class="selected">
		<a href="javascript:void(0);" data-pb-rseat="1">日榜<span class="arrow"></span></a>
	</li>
	<li>
		<a href="javascript:void(0);" data-pb-rseat="1">周榜<span class="arrow"></span></a>
	</li>
	<li>
		<a href="javascript:void(0);" data-pb-rseat="1">月榜<span class="arrow"></span></a>
	</li>
	<li class="last">
		<a href="javascript:void(0);" data-pb-rseat="1">总榜<span class="arrow"></span></a>
	</li>
</ul> -->
			<div class="tab-content tab-cur">
					...
					<ol>
						<div>
							<td><img src="http://www.cctv_img.com/<?php echo $value['user_img']; ?>" height="50px;" width="50px"></td>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<div class="ranks-wrap user-ranks">
			<h2 class="page-title">
				人气榜<span class="ico ico-logo-m"></span>
				<a class="ico ico-help-small">
					<p class="tip">根据用户送出的星光个数排名<span class="arrow"><span class="inner"></span></span></p>
				</a>
			</h2>
		<!-- 	<ul class="tab-title" data-pb-block="15041020">
			<li class="selected">
				<a href="javascript:void(0);" data-pb-rseat="1">日榜<span class="arrow"></span></a>
			</li>
			<li>
			...
			<div class="tab-content tab-cur" >
					...
					<?php foreach ($rankDate as $key => $value) { ?>
					<ol>
						<div>
							<td><img src="http://www.cctv_img.com/<?php echo $value['user_img']; ?>" height="50px;" width="50px"></td>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<td><?php echo $value['user_fans']; ?></td>
						</div>
					</ol>
					<?php }; ?>
			</div>
