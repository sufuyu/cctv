...
<div class="category-nav" data-pb-block="15041014">
	<ul class="tab-tit">
		<?php foreach ($navList as $key => $value) { ?>
			<li>
				<a href="{{url('square/search')}}?cate_id=<?php echo $value['cate_id']; ?>"><?php echo $value['cate_name']; ?><span class="arrow"></span></a>
			</li>
		<?php }; ?>
...
<!-- /.layout-side -->
		...
		<div class="filtrate clearfix">
				...
				<?php foreach ($liveList as $key => $value) { ?>

					<li>
						<div class="live-panel">
							<div class="host-pic">
								<img class="thumb" src="http://www.cctv_img.com/<?php echo $value['user_img']; ?>"
									 >
							...
							<h4 class="name">
								<a href="183413.htm" tppabs="http://x.pps.tv/room/183413"
								   target="room" data-pb-rseat="1"><?php echo $value['user_name']; ?></a>
							</h4>

							<p class="count"><span class="ico ico-peo"></span>&<?php echo $value['user_fans']; ?></p>

							<p class="zuobiao"><span class="ico ico-zuobiao"></span><?php echo $value['user_address']; ?></p>

							<p class="level"><span class="ico-lv zb-lv lv14"></span></p>
							<span class="live-tip live-tip-syc"><?php echo $value['cate_name']; ?></span>							
					</div>
					</li>
				<?php }; ?>
